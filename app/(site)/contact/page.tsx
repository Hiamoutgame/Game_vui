    ...
    <main id="main-content" className="px-5 py-20 md:px-10 lg:px-24 min-h-[85vh] flex flex-col items-center">
      <div className="w-full max-w-5xl space-y-12">
        ...
        <div className="flex justify-center">
          <div className="flex flex-col justify-between w-full max-w-sm rounded-sm border border-[color:var(--neon-cyan)] bg-[color:var(--neon-purple)] p-8 shadow-[0_0_30px_rgba(130,0,255,0.4)] min-h-[420px]">
            <div className="space-y-6">
              ...
              <div className="space-y-4 pt-4 border-t border-[color:var(--neon-cyan)]/30">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a href={`mailto:${site.contactPerson.email}`} className="font-semibold text-white text-sm hover:text-[color:var(--neon-cyan)] transition break-all">
